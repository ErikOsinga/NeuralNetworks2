...
def show_input_and_prediction(image_number,predictions,x_train,y_train,epoch):
	...
	# plt.show()
	output_dir = './predictions_28_conv/'
...
model = Sequential()
model.add(Conv2D(16,kernel_size=(5,5),padding='same',activation='relu',input_shape=(28,28,3)))
...
plt.legend()
plt.savefig('./predictions_28_conv/loss.png')

print ('Saving Model...')
model.save('./archive/network_cnn.h5')
