...
figsave_dir = './predictions_cnn_200_test/'
...
model.add(Conv2D(32,kernel_size=(10,10),padding='same',activation='relu',input_shape=(200,200,3)))

model.add(Conv2D(16,kernel_size=(10,10),padding='same',activation='relu'))

model.add(Conv2D(16,kernel_size=(10,10),padding='same',activation='relu'))

model.add(Conv2D(8,kernel_size=(10,10),padding='same',activation='relu'))
...
print ('Saving Model...')
model.save('./archive/network_cnn_200_testing.h5')
