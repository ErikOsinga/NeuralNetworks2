...
figsave_dir = './predictions_cnn_512/'
...
model.add(Conv2D(8,kernel_size=(5,5),padding='same',activation='relu',input_shape=(512,512,3)))
...
print ('Saving Model...')
model.save('./archive/network_cnn_512.h5')
